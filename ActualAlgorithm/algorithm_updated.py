...
def main():
    ...
    distance_dict_yz_plane = gops.get_dist_dict_yz(line1, line2)
    distance_dict_zx_plane = gops.get_dist_dict_zx(line1, line2)
    ...
    while not point_of_int__xy_plane_flag:
        ...
        if len(final_points_xy_plane) == 3:
            ...
            # convex_check(new_quad_points_cp1, new_quad_points_cp2)

            """
            for second set of polygon points
            """
            ...
            # you have to take the alternate points as short_line_1 and short_line_2 co-ordinates
            # belong to different lines.
            # polygon_check = sp.Polygon(*final_points_xy_plane)
