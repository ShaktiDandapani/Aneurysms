...
def main():
    ...
    line1 = [p3D.Point3D(1, 3, 1), p3D.Point3D(3, 4, 2), p3D.Point3D(5, 4, 3), p3D.Point3D(7, 4, 4)]
    ...
    while not point_of_int__xy_plane_flag:
        ...
        if len(final_points_xy_plane) == 3:
            ...
            #print 'possible convex quad forming points --> ', four_possible_points
            ...
            if type(polygon_cp1) == poly.Polygon:
            ...
            if type(polygon_cp2) == poly.Polygon:
            ...
            print 'convex points: ', convex_polygon_points

        else:
            # four points directly
            four_possible_points = final_points_xy_plane
        ...
        #
        # print 'possible points', four_possible_points
        #
        # line1_p1 = sp.Point(four_possible_points[0][0], four_possible_points[0][1])
        # line1_p2 = sp.Point(four_possible_points[1][0], four_possible_points[1][1])
        #
        # line2_p1 = sp.Point(four_possible_points[0][0], four_possible_points[2][1])
        # line2_p2 = sp.Point(four_possible_points[0][0], four_possible_points[3][1])
        #
        # l1, l2 = sp.Line(line1_p1, line1_p2), sp.Line(line2_p1, line2_p2)
        #
